    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                { transitionName: 'example', transitionLeave: false },
                dropdown
            )
        );
    }
...
React.render(React.createElement(CreateInternshipInterface, null), document.getElementById('createInternshipInterface'));
