...
class ResultsUI implements UI {
    ...
    private static function getPager($name = null, $deptId = null, $term = null, $ugradMajor = null, $gradProg = null, $level = null, $type = null, $campus = null, $loc = null, $state = null, $country = null, $workflowState = null, $courseSubject = null, $courseNum = null, $courseSect = null, $oied = null, $faculty = null)
    {
        ...
        if (isset($level)) {
            ...
            if($sLevel->getLevel() == Level::UNDERGRAD){
                $pager->addWhere('level', Level::UNDERGRAD);
            } else if ($sLevel->getLevel() == Level::GRADUATE) {
                $pager->addWhere('level', Level::GRADUATE, null, 'OR', 'grad_level');
            }

            // Major
            if ($sLevel->getLevel() == Level::UNDERGRAD && isset($ugradMajor) && $ugradMajor != -1) {
                // Undergrad major
                $pager->addWhere('major_code', $ugradMajor);
            } else if ($sLevel->getLevel() == Level::GRADUATE && isset($gradProg) && $gradProg != -1) {
                // Graduate program
