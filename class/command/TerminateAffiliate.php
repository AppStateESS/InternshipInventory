...
class TerminateAffiliate {
    ...
    public function execute()
    {
        ...
        NQ::simple('intern', INTERN_SUCCESS, 'Terminated internship for ' . $affiliate_agreement->getName());
        NQ::close();
        return PHPWS_Core::reroute('index.php?module=intern&action=affil_agree_edit_view');
    }
}
