...
<span id='Autolinker-property-invalidProtocolRelMatchRegex'>	/**
</span>	 * @private
...
<span id='Autolinker-method-isValidMatch'>	/**
</span>	 * Determines if a given match found by {@link #processTextNode} is valid. Will return `false` for:
	 * 
