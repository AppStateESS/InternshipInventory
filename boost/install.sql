...
CREATE TABLE intern_internship (
       ...
       other_type TEXT,
       loc_address varchar NOT NULL default '',
       loc_city varchar NOT NULL default '',
       loc_country varchar NOT NULL default 'United States',
       loc_state varchar NOT NULL default '',
       loc_zip varchar NOT NULL default '',
       credits INT NULL,
