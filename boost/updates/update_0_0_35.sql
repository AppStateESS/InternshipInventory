...
ALTER TABLE intern_internship ADD COLUMN gpa VARCHAR NULL;
...
ALTER TABLE intern_internship ADD COLUMN ugrad_major INT NULL REFERENCES intern_major(id);
ALTER TABLE intern_internship ADD COLUMN grad_prog INT NULL REFERENCES intern_grad_prog(id);
